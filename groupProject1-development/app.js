...
var foods
var foodType
var coldFoods = ["Pho", "Hot Pot", "Soon Do Boo", "Hot Choclate", ""]
...
//****************************************************************************************
            ...
            //grab the temperature of the weathe API
                ...
                if( temperature < 70){
                    ...
                    for (var i=0; i < coldFoods.length; i++) {
                        var request = {
                            location: center,
                            radius: '5000',
                            keyword: coldFoods[i]
            ...
            $(".foodType").html("It's "+ foodType + "!" + " Check out some of our curated food choices below:");
